...
const API_KEY = "4107MQ2AMQBXppK54zbbcD5YVouTTlE3fMXHvABj"
    ...
    return (
      <div className="GetImageForm">
        <form>
          ...
          <select onChange={this._change} id="rover" value={this.state.rover}>
            <option value="Curiosity">Curiosity</option>
            <option value="Opportunity">Opportunity</option>
            <option value="Spirit">Spirt</option>
          </select>
          <label htmlFor="camera">Camera Type</label>
          <select onChange={this._change} id="rover" value={this.state.camera}>
